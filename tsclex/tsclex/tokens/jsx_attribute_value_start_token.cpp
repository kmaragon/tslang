...
jsx_attribute_value_start_token::jsx_attribute_value_start_token(value_type type)
	: type_(type) {}

bool jsx_attribute_value_start_token::operator==(
	const jsx_attribute_value_start_token& other) const {
...
jsx_attribute_value_start_token::value_type jsx_attribute_value_start_token::type() const noexcept {
	return type_;
}
