...
#include "separators_not_allowed_here.hpp"

using namespace tscc::lex;

separators_not_allowed_here::separators_not_allowed_here(
	const tscc::lex::source_location& location) noexcept
	: lex_error(location) {}

const char* separators_not_allowed_here::what() const noexcept {
